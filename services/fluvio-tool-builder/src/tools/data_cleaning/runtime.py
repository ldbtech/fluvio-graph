...
class DataCleaningRuntime(DataCleaningTool):
    ...
    async def _run_sql(self, db_url: str, sql: str) -> str:
    ...
    async def clean_table(
        ...
        try:
            ...
            """
            await self._run_sql(db_url, clone_sql)
            ...
            for op in operations:
                ...
                if op == "normalize_headers":
                    ...
                    cols_res = await self._run_sql(db_url, cols_sql)
                    ...
                    if delete_conditions:
                        ...
                        await self._run_sql(db_url, delete_sql)
                    ...
                    """
                    await self._run_sql(db_url, dedup_sql)
            ...
            final_count_str = await self._run_sql(db_url, count_sql.replace(table_name, clean_table_name))

...
def build_capability_orchestrator(client, *, planner_dir: str = "planner_caps"):
    ...
    to mirror/search capabilities in fluvio-graph.
    ...
    store = GraphPlannerStore(planner_dir, client=client)
    app._store = store
    try:

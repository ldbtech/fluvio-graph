...
import type { BrainTab, ConnectorId, ConnectorStatus } from "@/shared/lib/types";
import { PERSONAL_CONNECTOR_IDS } from "@/shared/lib/workspaceKinds";

const TABS: { id: BrainTab; short: string }[] = [
...
export function BrainDomainTabs({
  ...
  const ready = (id: BrainTab) => {
    ...
    return connectorStatus[id as ConnectorId] === "ready";
  };
